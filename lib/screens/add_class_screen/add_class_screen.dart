...
class AddClassScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Form(
            key: _addClassController.formKey,
            child: Column(
                  ...
                  children: [
                    ...
                    IconButton.outlined(
                      ...
                      style: OutlinedButton.styleFrom(
                        side:
                            BorderSide(color: AppColors.primaryClr, width: 2.w),
                      ),
                    )
                  ],
                ),
  ...
  void _formOnSubmit(AddClassController controller) async {
    if (controller.formKey.currentState!.validate()) {
      await controller.createClassToFirebase();
    }
  }
}
